...
export const articles: Article[] = [
  ...
  },
  {
    ...
    title: '第50屆全國學生劍道錦標賽完整公告：竹劍三項新制＋3/29亞錦賽國家隊合同稽古',
    excerpt: '114學年度第50屆全國學生劍道錦標賽3月28至29日在臺北市立體育館7樓登場。本屆竹劍檢驗正式納入長短、重量、粗細三項標準，在各組報到當下驗劍，未通過者不得上場。賽後加碼：3/29日賽程結束後舉辦1AOKC亞錦賽國家代表隊合同稽古，免費開放所有劍友換裝參加。',
    category: 'competition',
    format: 'F2',
    author: '編輯部',
    ...
    tags: ['全國學生劍道', '竹劍檢驗', '賽事公告', 'AOKC', '合同稽古', '中華民國劍道協會', '臺北體育館'],
    readTime: 6,
    content: [
      '中華民國劍道協會主辦、臺北市政府體育局協辦的「114學年度第50屆全國學生劍道錦標賽」（運動績優生升學指定盃賽）將於中華民國115年3月28日（六）、29日（日）上午8時起，在臺北市立體育館7樓（臺北市松山區南京東路四段10號）正式開打。領隊會議於3月28日上午8時在比賽地點現場召開，參賽各單位代表請準時出席。',
      '【竹劍檢驗三項新制】本屆明文規定竹劍規格以中華民國劍道協會最新比賽規則為準，驗劍項目涵蓋三個面向：長短、重量、粗細。特別說明：本次大會新增竹劍檢驗器，國中以上的組別將使用竹劍檢驗器測量竹劍劍尖皮（先革）及最小直徑之粗細。驗劍時間為大會期間每日各組別之報到時間，未通過檢驗之竹劍不得使用——違規使用者該場比賽以失敗論。請所有選手賽前務必確認手中竹刀符合規格，並建議備妥備用竹刀。',
      '【比賽組別與禁用技術】本屆設有九個團體組別（含得分賽與過關賽兩種賽制）及十個個人賽組別，涵蓋大專、高中、國中、國小各年段男女組。規則提醒：高中組選手本次禁用二刀比賽；國中與國小組選手則禁止使用二刀、上段架構比賽及刺擊喉部，如違規使用該場比賽以失敗論。資格提醒：高中組選手需為96.9.1後、國中組需為99.9.1後出生者；大專組以114學年度第二學期正式學生為限，不含旁聽生、研究生等。',
      '【費用與注意事項】報名費：團體賽大專/高中/國中各項目每隊1,750元；國小各項目每隊1,350元；個人賽每人350元。大會統一投保公共意外責任險，但本次不提供代訂便當服務，午餐請自備，並請自備比賽用紅白帶。藥物管制：本次賽事TUE（治療用途豁免）申請截止日為3月27日，有需求的選手務必提前處理。申訴或騷擾事件聯絡人：副秘書長吳孟軒先生，電話(02)2891-8640，手機0933-333-174。',
      '【3/29賽後加碼：1AOKC國家代表隊合同稽古，全員免費開放】3月29日（週日）賽程結束後，大會將舉辦「第1回亞洲大洋洲劍道錦標賽（1AOKC）國家代表隊合同稽古大會」。1AOKC是亞洲劍道史上首屆獨立洲際錦標賽，將於2026年5月30至31日在東京武道館揭幕，台灣代表隊已完成選拔，即將出征東京。本次合同稽古免報名費，開放所有在場劍友主動換裝參加共襄盛舉，唯保險費用需由個人自理。這是在國內近距離與即將出征亞錦賽的國家代表隊共同稽古的難得機會，大會特別邀請各位劍友把握。',
      '各組報到時間與場地賽程圖已於協會官網公告，請參閱：http://www.rocka.org.tw/info/2026/students_details.html',
    ],
    references: [
      { label: '中華民國劍道協會——114學年度第50屆全國學生劍道錦標賽競賽規程（官方PDF）', url: 'http://www.rocka.org.tw/info/2026/students_details.html' },
      { label: '臺北市芳和實驗中學轉知公告', url: 'https://www.fhehs.tp.edu.tw/news/轉知中華民國劍道協會辦理「114學年度第50屆全國學生劍道錦標賽」一案，請各校協助所屬人員代表學校報名參加，並依權責核予公（差）假登記及課務派代/' },
